...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"圖譜分析器 v3.3_for GP and LC", pos = wx.DefaultPosition, size = wx.Size( 460,647 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
